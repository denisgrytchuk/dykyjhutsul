...
//or however you get a handle to the IMG
        ...
        if(width>height){
            show.css({display:'flex',padding:'0% 17%'});
        }
        else {
            show.css({display:'flex',padding:'0% 35%'});
        }
        $('.navbar div').css({'pointer-events':'none',opacity:'0.2'});
    });
    ...
    $('.esc').on('click',function (e) {
        $('.navbar div').css({'pointer-events':'all',opacity:'1'});
